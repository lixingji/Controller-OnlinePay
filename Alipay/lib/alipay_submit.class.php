 ...
 */
require_once(dirname(dirname(__FILE__)) . '/lib/alipay_core.function.php');
require_once(dirname(dirname(__FILE__)) . '/lib/alipay_md5.function.php');
...
//		$sHtml = $sHtml."<input type='submit' onclick='submitClick()' value='".$button_name."'><script>function submitClick(){document.forms['alipaysubmit'].submit();}</script>";
